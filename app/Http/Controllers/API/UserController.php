...
class UserController extends Controller
{
    ...
    public function index(Request $request, $id = null)
    {
        $data = [];
        $items = User::query();
        // $items->whereNot('nik','super-admin');
        ...
        if ($id == null) {
            ...
            $items->with(['creator:id,name', 'updater:id,name']);
    ...
    public function update(Request $request)
    {
        ...
        $validator = Validator::make($data, [
            ...
            'name' => 'required|string|max:128',
            'email' => ['required', 'email:rfc,dns', Rule::unique(User::class, 'email')->ignore($data['id'])],
    ...
    public function delete(Request $request)
    {
        ...
        User::whereIn('id', $ids)->whereNot('id', auth()->user()->id)->delete();
